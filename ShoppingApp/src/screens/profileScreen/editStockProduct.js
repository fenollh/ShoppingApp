...
import { editStockProduct, removeStockProduct } from '../../components/globalFunctions';
import { FlatList } from 'react-native-gesture-handler';


export default class EditStockProduct extends React.Component {
    constructor(props){
        super(props)
        this.state = {
            image: '',
    ...
    componentDidMount = () => {
        const {item} = this.props.props.route.params
        this.setState({
            image: item.image,
            name: item.name,
                ...
                <View style={styles.mainBox}>
                    ...
                    <View style={{flex:1, flexDirection: 'row'}}>
                        <TouchableOpacity 
                            ...
                            activeOpacity={0.6}
                            onPress={()=>{
                                removeStockProduct(this.props.props.route.params.index)
                        ...
                        <TouchableOpacity 
                            ...
                            onPress={()=>{
                                if(this.state.name && this.state.cost) {
                                    editStockProduct(this.state, this.props.props.route.params.index)
                                    this.props.props.navigation.goBack()
                                }
