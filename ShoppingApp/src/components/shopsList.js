...
const Shops = [
    ...
    stock: {
        availableTables: 0,
        availableProducts: [
            {name: 'Pollo asado', description: 'Deliciosos pollos asados por encargo', image: 'https://www.hola.com/imagenes/cocina/recetas/20200130159403/pollo-asado-en-horno-de-lena/0-779-940/pollo-asado-m.jpg', cost: 15, quantity: -1, tags: ['pollo asado'] }, //si en el parametro quantity se pone un numero negativo la cantidad del producto es indefinida
            ...
            {name: 'Lasaña', description: 'Lasaña para llevar de calidad', image: 'https://www.recetasdesbieta.com/wp-content/uploads/2018/10/lasagna-original..jpg', cost: 4, quantity: 10, tags: ['lasana'] },
