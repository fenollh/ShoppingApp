...
const Shops = [
    ...
    stock: {
        availableSpace: 0,
        availableProducts: [
            {name: 'Pollo asado', description: 'Deliciosos pollos asados por encargo', image: 'https://www.hola.com/imagenes/cocina/recetas/20200130159403/pollo-asado-en-horno-de-lena/0-779-940/pollo-asado-m.jpg', cost: 15, quantity: -1, tags: ['Pollos'] }, //si en el parametro quantity se pone un numero negativo la cantidad del producto es indefinida
            ...
            {name: 'Lasaña', description: 'Lasaña para llevar de calidad', image: 'https://www.recetasdesbieta.com/wp-content/uploads/2018/10/lasagna-original..jpg', cost: 4, quantity: 10, tags: ['Raciones'] },
            {name: 'Ensaladilla', description: 'Ensaladilla para llevar de calidad', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRS8UKi2vWGlEQ3tiOTMIM6ZhHW_nX5p_DeIA&usqp=CAU', cost: 4, quantity: 5, tags: ['Raciones'] },
    ...
    stock: {
        availableSpace: 7,
        availableProducts: [
            {name: 'Hamburguesa', description: 'Hamburgesa con bacon y queso', image: 'https://e00-marca.uecdn.es/assets/multimedia/imagenes/2019/02/07/15495589360473.jpg', cost: 15, quantity: -1, tags: ['hamburgesas'] }, //si en el parametro quantity se pone un numero negativo la cantidad del producto es indefinida
    ...
    stock: {
        availableSpace: 0,
        availableProducts: [
            {name: 'Badminton', description: 'Clases extraescolares de badminton', image: 'https://1.bp.blogspot.com/_-nzaxjFGHOY/S7HITc_o_dI/AAAAAAAABV4/TMAEdVXHRnA/s1600/Badminton2010.jpg', cost: 30, quantity: -1, tags: ['Extraescolares'] }, //si en el parametro quantity se pone un numero negativo la cantidad del producto es indefinida
            {name: 'Natacion', description: 'Clases extraescolares de natacion', image: 'https://lh3.googleusercontent.com/proxy/ik0AG9PTwY093-JB8kEzExZXKCr0OrGiTFQV1NXW2ikvCnew73g28NlMUj7zvSYtRad1WrZHQC4Gq7vJKV56krQye3wLt7OdXtMLsD8rYlmPvZmb3srb5RgQahYTTJ5_ZjsC7ta7kVLFYhI', cost: 30, quantity: -1, tags: ['Extraescolares'] },
            {name: 'Pistas de Badminton', description: 'Reserva de pistas de badminton', image: 'https://www.webconsultas.com/sites/default/files/pista_badminton.jpg', cost: 4, quantity: -1, tags: ['Instalaciones'] },
            {name: 'Tenis', description: 'Clases extraescolares de tenis', image: 'https://i.eurosport.com/2020/05/20/2821602-58197075-1600-900.jpg', cost: 30, quantity: -1, tags: ['Extraescolares'] },
            {name: 'Gimnasio', description: 'Reserva de plaza para el gimnasio', image: 'https://as01.epimg.net/argentina/imagenes/2020/04/15/tikitakas/1586970559_336126_1586972774_noticia_normal.jpg', cost: 30, quantity: -1, tags: ['Instalaciones'] },
        ]
